...
public class NavigationDrawerFragment extends Fragment {
    ...
    RippleView rippleMovie,rippleTv,rippleSearch;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rippleMovie = (RippleView) v.findViewById(R.id.nav_ripple1);
        rippleTv = (RippleView) v.findViewById(R.id.nav_ripple2);
        rippleSearch =  (RippleView) v.findViewById(R.id.nav_ripple0);
        ...
        rippleMovie.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            @Override
            public void onComplete(RippleView rippleView) {
                selectItem(1);
                mDrawerLayout.closeDrawers();
        ...
        rippleTv.setOnRippleCompleteListener(new RippleView.OnRippleCompleteListener() {
            @Override
            public void onComplete(RippleView rippleView) {
                selectItem(2);
                mDrawerLayout.closeDrawers();
